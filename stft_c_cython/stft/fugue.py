...
#extract the info
length = 265152#int(len(audData))#audData.shape[0] # this is the number of samples,
#if you divide length by the rateyou get the length in seconds /rate
#print(length, length/rate)
#sys.exit(-1)
channel1 = audData[0:length*2]
...
#channel2 = audData[:,1]
windowSize = 8192*10 #length of the window to analyse with STFT
hopSize = 8192*10  #hopsize between windows
